...
function Home() {
	...
	return (
		<div>
			...
			<div
				id="about"
				className={`pt-2 sm:pt-[40px] w-full md:flex md:flex-row-reverse md:justify-between items-center`}
			>
				<div>
					<div className={`${width > 640 ? "flex justify-center" : ""}`}>
						...
						<div className="flex justify-center bg-photo rounded-[20px] pt-5 px-2 h-[240px] sm:h-[500px] md:h-[360px] xl:h-[500px]">
							<img
								className="h-[220px] sm:h-[480px] md:h-[340px] xl:h-[480px]"
								src={profil}
								alt=""
							/>
						</div>
				...
				>
					<div className="mt-6 md:mt-0">
						...
						<div className="text-neutral-100 text- mt-2 md:mt-6">
							I'm a Computer Science student in BINUS University Indonesia. I
							have been working on school and independent project as a UI/UX
							designer and front-end developer for one year. Currently I'm
							looking forward to gain experiences from collaborating with you!
						</div>
						<div className="flex font-normal gap-[32px] xl:gap-[40px] mt-6">
							<a
								href="mailto:william28.office@gmail.com?subject=Work request"
								rel="noreferrer"
							>
								<div className="flex gap-2 items-center">
									...
									/>
									{width > 1024 && (
										<div className="text-primary-100 font-normal">Email</div>
									)}
								</div>
							</a>
							<a
								href="https://wa.me/6282177150569?text=Hello I'd would like to ask something"
								rel="noreferrer"
								target="_blank"
							>
								<div className="flex gap-2 items-center">
									...
									/>
									{width > 1024 && (
										<div className="text-whatsapp ">Whatsapp</div>
									)}
								</div>
							</a>
							<a
								href="https://github.com/William2809"
								target="_blank"
								rel="noreferrer"
							>
								<div className="flex gap-2 items-center">
									<img
										...
										alt="github"
									/>
									{width > 1024 && <div className="text-white ">Github</div>}
								</div>
							</a>
							<a
								href="https://www.linkedin.com/in/william-huang-4011251b1/"
								target="_blank"
								rel="noreferrer"
							>
								<div className="flex gap-2 items-center">
									...
									/>
									{width > 1024 && (
										<div className="text-linkedin ">Linked In</div>
									)}
								</div>
							</a>
						</div>
						...
						<div className="flex gap-2 mt-6">
							...
							<a
								...
								href="https://drive.google.com/file/d/1yydpOSMkMGiG5dQQUHlQj2Ki8Th8Jxg_/view?usp=sharing"
								target="_blank"
								rel="noreferrer"
							>
								Download CV
			...
			<div
				...
				className="pt-[50px] mt-[50px]"
			>
				<div className="text-white text-32 font-bold">My Skills</div>
