        ...
        <div>
            ...
            <div className="flex gap-4 mt-2">
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiHtml5 size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiHtml5" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiHtml5")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiCss3 size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiCss3" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiCss3")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiTailwindcss size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer  ${skillActive === "SiTailwindcss" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiTailwindcss")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiBootstrap size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer  ${skillActive === "SiBootstrap" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiBootstrap")} onMouseLeave={mouseLeave} />
            ...
            <div className="flex gap-4 mt-4">
                <div className={`flex p-2 items-center h-[40px] bg-primary-200 rounded-lg cursor-pointer`} onMouseEnter={() => mouseEnter("SiJavascript")} onMouseLeave={mouseLeave}>
                ...
                <div className={`flex p-2 items-center h-[40px] bg-primary-200 rounded-lg cursor-pointer`} onMouseEnter={() => mouseEnter("SiTypescript")} onMouseLeave={mouseLeave}>
                ...
                <div className={`flex p-2 items-center h-[40px] bg-primary-200 rounded-lg cursor-pointer z-10`} onMouseEnter={() => mouseEnter("SiCplusplus")} onMouseLeave={mouseLeave}>
                ...
                <div className={`flex p-2 items-center h-[40px] bg-primary-200 rounded-lg cursor-pointer`} onMouseEnter={() => mouseEnter("SiC")} onMouseLeave={mouseLeave}>
            ...
            <div className="flex gap-4 mt-3">
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiMongodb size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiMongodb" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiMongodb")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiExpress size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiExpress" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiExpress")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiReact size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiReact" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiReact")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiNodedotjs size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiNodedotjs" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiNodedotjs")} onMouseLeave={mouseLeave} />
            ...
            <div className="flex gap-4 mt-3">
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiLaravel size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiLaravel" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiLaravel")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiMysql size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiMysql" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiMysql")} onMouseLeave={mouseLeave} />
            ...
            <div className="flex gap-4 mt-3">
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiJava size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiJava" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiJava")} onMouseLeave={mouseLeave} />
            ...
            <div className="flex gap-4 mt-3">
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiVisualstudiocode size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiVisualstudiocode" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiVisualstudiocode")} onMouseLeave={mouseLeave} />
                ...
                <div className={`flex items-center bg-primary-200 rounded-lg`} >
                    <SiGithub size="24px" className={`z-10 p-2 h-[40px] w-[40px] text-white cursor-pointer ${skillActive === "SiGithub" ? "animate-pulse" : ""}`} onMouseEnter={() => mouseEnter("SiGithub")} onMouseLeave={mouseLeave} />
